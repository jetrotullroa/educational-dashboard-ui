...
<div>
  <h3 class="font-semibold text-2xl mb-4">Teachers</h3>
  <div class="grid grid-cols-2 gap-4">
    {#each teachers as { id, name, subjects, year_of_experience }}
      <a href="/teachers/{id}">
        <div class="card bg-teal-400 shadow-xl col-span-1 mb-4 cursor-pointer">
          <figure class="mt-8">
            <div class="avatar placeholder">
              <div class="bg-neutral text-neutral-content rounded-full w-24">
                <span class="text-3xl">{getInitials(name)}</span>
              </div>
            </div>
          </figure>
